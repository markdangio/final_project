...
public class UserActions {
     ...
     */
    public static boolean addUser(String username, String password, String firstname, String lastname, String email,
            String avatar, String birthday) {

        User newUser = new User(username, password, firstname, lastname, email, avatar, birthday);
